        ...
        <div className="outer">
            <div className="imprint">
                ...
                <section className="imprint--contact">
                    ...
                    <p>E-Mail:&nbsp;&nbsp;<a className="extern" href="mailto:kunst.lindemann@gmail.com">kunst.lindemann@gmail.com</a></p>
                    <p className="imprint--contact--mail">Quelle:&nbsp;&nbsp;<a className="extern" target="_blank" rel="noreferrer" href="https://www.e-recht24.de">E-Recht24</a></p>
                </section>
                <h2 className="imprint--header">Haftung für Inhalte</h2>
                <p className="imprint--text">
                    Als Dienste Anbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich.
                    Nach §§ 8 bis 10 TMG sind wir als Dienste Anbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu
                ...
                <p className="imprint--text">
                    ...
                    Inhalte waren zum Zeitpunkt der Verlinkung nicht erkennbar. Eine permanente inhaltliche Kontrolle der verlinkten Seiten ist jedoch
                ...
                <p className="imprint--text">
                    ...
                    den privaten, nicht kommerziellen Gebrauch gestattet. Soweit die Inhalte auf dieser Seite nicht vom Betreiber erstellt wurden,
